...
class RPN(nn.Module):
    def __init__(self, config):
        super().__init__()
        rpn_channel = config.rpn_channel
        self.config = config  
